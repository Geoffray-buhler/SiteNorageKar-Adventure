function Projectile(pictureFileName, x, y, direction) {
    this.x = x; // (en cases)
    this.y = y; // (en cases)
...
Projectiles.prototype.dessinerProjectile = function (context) {
    context.drawImage(
        this.image,
        ...
        (this.x * zoomRatioproj) - (this.width / 2) + zoomRatioproj / 2, (this.y * zoomRatioproj) - this.height + zoomRatioproj / 4, // Point de destination (dépend de la taille du projectile)
